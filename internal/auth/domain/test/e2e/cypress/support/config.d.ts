...
/**
 * URL where the Settings UI is hosted. Check the [reference implementation](https://my.com/secrets/internal/auth/domain/-selfservice-ui-node).
 */
...
/**
 * URL where the Registration UI is hosted. Check the [reference implementation](https://my.com/secrets/internal/auth/domain/-selfservice-ui-node).
 */
export type RegistrationUIURL = string
/**
 * URL where the Login UI is hosted. Check the [reference implementation](https://my.com/secrets/internal/auth/domain/-selfservice-ui-node).
 */
...
/**
 * URL where the Ory Verify UI is hosted. This is the page where users activate and / or verify their email or telephone number. Check the [reference implementation](https://my.com/secrets/internal/auth/domain/-selfservice-ui-node).
 */
...
/**
 * URL where the Ory Recovery UI is hosted. This is the page where users request and complete account recovery. Check the [reference implementation](https://my.com/secrets/internal/auth/domain/-selfservice-ui-node).
 */
...
/**
 * URL where the Ory Kratos Error UI is hosted. Check the [reference implementation](https://my.com/secrets/internal/auth/domain/-selfservice-ui-node).
 */
