...
import (
	...
	"my.com/secrets/internal/auth/domain/embedx"
)
...
func (p *Config) validateIdentitySchemas(ctx context.Context) error {
	opts := []httpx.ResilientOptions{
		...
		httpx.ResilientClientWithTracer(noop.NewTracerProvider().Tracer("my.com/secrets/internal/auth/domain/driver/config")),
	}
