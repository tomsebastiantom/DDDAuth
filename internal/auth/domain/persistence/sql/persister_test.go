...
import (
	...
	continuity "my.com/secrets/internal/auth/domain/continuity/test"
	...
	ri "my.com/secrets/internal/auth/domain/identity"
	identity "my.com/secrets/internal/auth/domain/identity/test"
	"my.com/secrets/internal/auth/domain/persistence/sql"
	sqltesthelpers "my.com/secrets/internal/auth/domain/persistence/sql/testhelpers"
	"my.com/secrets/internal/auth/domain/schema"
	errorx "my.com/secrets/internal/auth/domain/selfservice/errorx/test"
	lf "my.com/secrets/internal/auth/domain/selfservice/flow/login"
	login "my.com/secrets/internal/auth/domain/selfservice/flow/login/test"
	recovery "my.com/secrets/internal/auth/domain/selfservice/flow/recovery/test"
	registration "my.com/secrets/internal/auth/domain/selfservice/flow/registration/test"
	settings "my.com/secrets/internal/auth/domain/selfservice/flow/settings/test"
	verification "my.com/secrets/internal/auth/domain/selfservice/flow/verification/test"
	sessiontokenexchange "my.com/secrets/internal/auth/domain/selfservice/sessiontokenexchange/test"
	code "my.com/secrets/internal/auth/domain/selfservice/strategy/code/test"
	link "my.com/secrets/internal/auth/domain/selfservice/strategy/link/test"
	session "my.com/secrets/internal/auth/domain/session/test"
	"my.com/secrets/internal/auth/domain/x/xsql"
)
...
func createCleanDatabases(t testing.TB) map[string]*driver.RegistryDefault {
	...
	for name, dsn := range conns {
		go func(name, dsn string) {
			...
			_, reg := external.NewRegistryDefaultWithDSN(t, dsn)
